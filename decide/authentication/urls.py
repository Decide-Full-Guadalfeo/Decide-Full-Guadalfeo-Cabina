...
from .views import GetUserView, LogoutView, IndexUserView, LoginUserView, RegisterUserView, CompleteVotingUserDetails, GetVotingUser
...
urlpatterns = [
    ...
    path('getVotingUser/', GetVotingUser.as_view()),
]
