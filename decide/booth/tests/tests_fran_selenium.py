...
class BoothTestCase(StaticLiveServerTestCase):
    ...
    def setUp(self):
        ...
        q7.save()
        qo19 = QuestionOption(number="4", option="Alvaro Aguilar / " + str(u2.id), question=q7)
        qo19.save()
        qo20 = QuestionOption(number="5", option="Nuría Garcia / " + str(u3.id), question=q7)
        qo20.save()
        qo21 = QuestionOption(number="6", option="Andrea Solar A / " + str(u4.id), question=q7)
        qo21.save()
        qo22 = QuestionOption(number="7", option="Andrea Solar B / " + str(u5.id), question=q7)
        qo22.save()
        qo23 = QuestionOption(number="8", option="Andrea Solar C / " + str(u6.id), question=q7)
        qo23.save()
        qo24 = QuestionOption(number="9", option="Andrea Solar D / " + str(u7.id), question=q7)
        qo24.save()
        qo25 = QuestionOption(number="10", option="Andrea Solar E / " + str(u8.id), question=q7)
        qo25.save()
        qo26 = QuestionOption(number="11", option="Alvaro Aguilar A / " + str(u9.id), question=q7)
        qo26.save()
        qo27 = QuestionOption(number="12", option="Alvaro Aguilar B / " + str(u10.id), question=q7)
        qo27.save()
        qo28 = QuestionOption(number="13", option="Alvaro Aguilar C / " + str(u11.id), question=q7)
        qo28.save()
        qo29 = QuestionOption(number="14", option="Alvaro Aguilar D / " + str(u12.id), question=q7)
        qo29.save()
        qo30 = QuestionOption(number="15", option="Alvaro Aguilar E / " + str(u13.id), question=q7)
        qo30.save()
        qo31 = QuestionOption(number="16", option="Alvaro Aguilar F / " + str(u14.id), question=q7)
        qo31.save()
