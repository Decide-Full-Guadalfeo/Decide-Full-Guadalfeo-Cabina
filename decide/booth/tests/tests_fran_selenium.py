...
class BoothTestCase(StaticLiveServerTestCase):
    ...
    def test_general_5_woman(self):
        ...
        time.sleep(3)
        assert self.driver.find_element(By.XPATH, "/html/body/div/div/div[2]/div[2]/div/form/div[1]/div[2]/div/div/div/div/label/div/div/div[1]/h3").text.contains("Alvaro Aguilar") 
