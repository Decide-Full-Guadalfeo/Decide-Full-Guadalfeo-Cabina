...
class BoothTestCase(StaticLiveServerTestCase):
    ...
    def setUp(self):
        ...
        u1.save()
        self.user1 = u1
        vu1 = VotingUser(user=u1, dni='45454545T', sexo='Man',
                         titulo='Software', curso='First', edad=18)
        vu1.save()
        self.votingUser = vu1
        t1 = Token(user=u1)
        t1.save()
        ...
        u2.save()
        self.user2 = u2
        vu2 = VotingUser(user=u2, dni='45454541T', sexo='Man',
                         titulo='Software', curso='First', edad=18)
        vu2.save()
        self.votingUser = vu2
        t2 = Token(user=u2)
        ...
        u3.save()
        self.user3 = u3
        vu3 = VotingUser(user=u3, dni='45454542T', sexo='Woman',
                         titulo='Software', curso='First', edad=18)
        vu3.save()
        self.votingUser = vu3
        t3 = Token(user=u3)
        ...
        u4.save()
        self.user4 = u4
        vu4 = VotingUser(user=u4, dni='45454543T', sexo='Woman',
                         titulo='Software', curso='First', edad=18)
        vu4.save()
        self.votingUser = vu4
        t4 = Token(user=u4)
        ...
        u5.save()
        self.user5 = u5
        vu5 = VotingUser(user=u5, dni='55555553T', sexo='Woman',
                         titulo='Software', curso='First', edad=18)
        vu5.save()
        self.votingUser = vu5
        t5 = Token(user=u5)
        ...
        u6.save()
        self.user6 = u6
        vu6 = VotingUser(user=u6, dni='66666663T', sexo='Woman',
                         titulo='Software', curso='First', edad=18)
        vu6.save()
        self.votingUser = vu6
        t6 = Token(user=u6)
        ...
        u7.save()
        self.user7 = u7
        vu7 = VotingUser(user=u7, dni='77777773T', sexo='Woman',
                         titulo='Software', curso='First', edad=18)
        vu7.save()
        self.votingUser = vu7
        t7 = Token(user=u7)
        ...
        u8.save()
        self.user8 = u8
        vu8 = VotingUser(user=u8, dni='88888888T', sexo='Woman',
                         titulo='Software', curso='First', edad=18)
        vu8.save()
        self.votingUser = vu8
        t8 = Token(user=u8)
        ...
        u9.save()
        self.user9 = u9
        vu9 = VotingUser(user=u9, dni='99999999T', sexo='Man',
                         titulo='Software', curso='First', edad=19)
        vu9.save()
        self.votingUser = vu9
        t9 = Token(user=u9)
        t9.save()
        ...
        u10.save()
        self.user10 = u10
        vu10 = VotingUser(user=u10, dni='11111111P', sexo='Man',
                          titulo='Software', curso='First', edad=110)
        vu10.save()
        ...
        u11.save()
        self.user11 = u11
        vu11 = VotingUser(user=u11, dni='11111111R', sexo='Man',
                          titulo='Software', curso='First', edad=111)
        vu11.save()
        ...
        u12.save()
        self.user12 = u12
        vu12 = VotingUser(user=u12, dni='12121212T', sexo='Man',
                          titulo='Software', curso='First', edad=121)
        vu12.save()
        ...
        u13.save()
        self.user13 = u13
        vu13 = VotingUser(user=u13, dni='13131313T', sexo='Man',
                          titulo='Software', curso='First', edad=131)
        vu13.save()
        ...
        u14.save()
        self.user14 = u14
        vu14 = VotingUser(user=u14, dni='14141414T', sexo='Man',
                          titulo='Software', curso='First', edad=141)
        vu14.save()
        ...
        q1.save()
        qo1 = QuestionOption(
            number="1", option="Alvaro Aguilar / 1", question=q1)
        qo1.save()
        qo2 = QuestionOption(
            number="2", option="Nuría Garcia / 2", question=q1)
        qo2.save()
        qo3 = QuestionOption(
            number="3", option="Andrea Solar / 3", question=q1)
        qo3.save()

        q2 = Question(desc='Pregunta 2')
        q2.save()
        qo4 = QuestionOption(
            number="1", option="Alvaro Aguilar / 1", question=q2)
        qo4.save()
        qo5 = QuestionOption(
            number="2", option="Nuría Garcia / 2", question=q2)
        qo5.save()
        qo6 = QuestionOption(
            number="3", option="Andrea Solar / 3", question=q2)
        qo6.save()

        q3 = Question(desc='Pregunta 3')
        q3.save()
        qo7 = QuestionOption(
            number="1", option="Alvaro Aguilar / 1", question=q3)
        qo7.save()
        qo8 = QuestionOption(
            number="2", option="Nuría Garcia / 2", question=q3)
        qo8.save()
        qo9 = QuestionOption(
            number="3", option="Andrea Solar / 3", question=q3)
        qo9.save()

        q4 = Question(desc='Pregunta 4')
        q4.save()
        qo10 = QuestionOption(
            number="1", option="Alvaro Aguilar / 1", question=q4)
        qo10.save()
        qo11 = QuestionOption(
            number="2", option="Nuría Garcia / 2", question=q4)
        qo11.save()
        qo12 = QuestionOption(
            number="3", option="Andrea Solar / 3", question=q4)
        qo12.save()

        q5 = Question(desc='Pregunta 5')
        q5.save()
        qo13 = QuestionOption(
            number="1", option="Alvaro Aguilar / 1", question=q5)
        qo13.save()
        qo14 = QuestionOption(
            number="2", option="Nuría Garcia / 2", question=q5)
        qo14.save()
        qo15 = QuestionOption(
            number="3", option="Andrea Solar / 3", question=q5)
        qo15.save()

        q6 = Question(desc='Pregunta 6')
        q6.save()
        qo16 = QuestionOption(
            number="1", option="Alvaro Aguilar / 1", question=q6)
        qo16.save()
        qo17 = QuestionOption(
            number="2", option="Nuría Garcia / 2", question=q6)
        qo17.save()
        qo18 = QuestionOption(
            number="3", option="Andrea Solar / 3", question=q6)
        qo18.save()

        q7 = Question(desc='Pregunta 7')
        q7.save()
        qo19 = QuestionOption(
            number="1", option="Alvaro Aguilar / " + str(u2.id), question=q7)
        qo19.save()
        qo20 = QuestionOption(
            number="2", option="Nuría Garcia / " + str(u3.id), question=q7)
        qo20.save()
        qo21 = QuestionOption(
            number="3", option="Andrea Solar A / " + str(u4.id), question=q7)
        qo21.save()
        qo22 = QuestionOption(
            number="4", option="Andrea Solar B / " + str(u5.id), question=q7)
        qo22.save()
        qo23 = QuestionOption(
            number="5", option="Andrea Solar C / " + str(u6.id), question=q7)
        qo23.save()
        qo24 = QuestionOption(
            number="6", option="Andrea Solar D / " + str(u7.id), question=q7)
        qo24.save()
        qo25 = QuestionOption(
            number="7", option="Andrea Solar E / " + str(u8.id), question=q7)
        qo25.save()
        qo26 = QuestionOption(
            number="8", option="Alvaro Aguilar A / " + str(u9.id), question=q7)
        qo26.save()
        qo27 = QuestionOption(
            number="9", option="Alvaro Aguilar B / " + str(u10.id), question=q7)
        qo27.save()
        qo28 = QuestionOption(
            number="10", option="Alvaro Aguilar C / " + str(u11.id), question=q7)
        qo28.save()
        qo29 = QuestionOption(
            number="11", option="Alvaro Aguilar D / " + str(u12.id), question=q7)
        qo29.save()
        qo30 = QuestionOption(
            number="12", option="Alvaro Aguilar E / " + str(u13.id), question=q7)
        qo30.save()
        qo31 = QuestionOption(
            number="13", option="Alvaro Aguilar F / " + str(u14.id), question=q7)
        qo31.save()
        ...
        a1 = Auth(name=f'{self.live_server_url}',
                  url=f'{self.live_server_url}', me=False)
        a1.save()
        v1.auths.add(a1)
    ...
    def test_flipping_card_functional(self):
        ...
        self.driver.find_element(
            By.XPATH, "/html/body/div/div/div[2]/div[2]/div/form/div[1]/div[2]/div/div/div/div/label/div/div/div[1]").click()
        time.sleep(1)

        assert self.driver.find_element(
            By.CSS_SELECTOR, ".flipped .flip-card-back > h4").text == "Has elegido"
        assert self.driver.find_element(
            By.CSS_SELECTOR, ".flipped .flip-card-back > h3").text.__contains__("Alvaro Aguilar")

        self.driver.find_element(
            By.CSS_SELECTOR, ".flipped .flip-card-back").click()
        time.sleep(1)
