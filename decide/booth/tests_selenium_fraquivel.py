...
class BoothTestCase(StaticLiveServerTestCase):
    ...
    def setUp(self):
        ...
        u15 = User(username='15', email='d@gmail.com')
        u15.set_password('153')
        u15.save()
        self.user15 = u15
        vu15 = VotingUser(user=u15, dni='15151515T', sexo='Man', titulo='Software', curso='First', edad=151)
        vu15.save()
        self.votingUser = vu15
        t15 = Token(user=u15)
        t15.save()
        self.token15 = t15

        u16 = User(username='16', email='d@gmail.com')
        u16.set_password('163')
        u16.save()
        self.user16 = u16
        vu16 = VotingUser(user=u16, dni='16161616T', sexo='Man', titulo='Software', curso='First', edad=161)
        vu16.save()
        self.votingUser = vu16
        t16 = Token(user=u16)
        t16.save()
        self.token16 = t16
        ...
        q7.save()
        qo19 = QuestionOption(number="4", option="Alvaro Aguilar / 4", question=q7)
        qo19.save()
        qo20 = QuestionOption(number="5", option="Nuría Garcia / 5", question=q7)
        qo20.save()
        qo21 = QuestionOption(number="6", option="Andrea Solar A/ 6", question=q7)
        qo21.save()
        qo22 = QuestionOption(number="7", option="Andrea Solar B/ 7", question=q7)
        qo22.save()
        qo23 = QuestionOption(number="8", option="Andrea Solar C/ 8", question=q7)
        qo23.save()
        qo24 = QuestionOption(number="9", option="Andrea Solar D/ 9", question=q7)
        qo24.save()
        qo25 = QuestionOption(number="10", option="Andrea Solar E/ 10", question=q7)
        qo25.save()
        qo26 = QuestionOption(number="11", option="Alvaro Aguilar A/ 11", question=q7)
        qo26.save()
        qo27 = QuestionOption(number="12", option="Alvaro Aguilar B/ 12", question=q7)
        qo27.save()
        qo28 = QuestionOption(number="13", option="Alvaro Aguilar C/ 13", question=q7)
        qo28.save()
        qo29 = QuestionOption(number="14", option="Alvaro Aguilar D/ 14", question=q7)
        qo29.save()
        qo30 = QuestionOption(number="15", option="Alvaro Aguilar E/ 15", question=q7)
        qo30.save()
        qo31 = QuestionOption(number="16", option="Alvaro Aguilar F/ 16", question=q7)
        qo31.save()
    ...
    #     time.sleep(1)
    #     self.driver.find_element(By.CSS_SELECTOR, ".p-3:nth-child(8) .default").click()
    #     self.driver.find_element(By.CSS_SELECTOR, ".p-3:nth-child(8) .default").click()
    #     time.sleep(1)
